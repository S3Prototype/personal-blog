...
- [Clerk's Supabase Integration docs](https://clerk.com/docs/integrations/databases/supabase)
...
- [TakeShape's API Indexing docs](https://app.takeshape.io/docs/schema/api-indexing-guide)
...
- [Vercel's Edge Function docs](https://vercel.com/docs/functions)
